...
<body>
    ...
    <div class="center">
        <div class="upload-form">
                    ...
                    if ($img_size > 10000000) {
                        ...
                        if (in_array($img_ex_lc, $allowed_exs)) {
                            ...
                            if (mysqli_num_rows($result) == 0) {
                                ...
                                $_SESSION['img_path'] = $img_upload_path;
                                // var_dump($_SESSION);
            ...
            <p class="upload-req">Adauga cateva cuvinte cheie care descriu imaginea</p>
            <form action="uploadfile.php" method="POST">
                <input type="hidden" name="path" value="<?= $new_img_name ?>" />
                <input type="text" name="tags" class="upload-tags" placeholder="Cuvinte cheie">
